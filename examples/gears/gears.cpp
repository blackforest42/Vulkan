/*
 * Vulkan Example - Drawing multiple animated gears (emulating the look of
 * glxgears)
 *
 * All gears are using single index, vertex and uniform buffers to show the
 * Vulkan best practices of keeping the no. of buffer/memory allocations to a
 * mimimum We use index offsets and instance indices to offset into the buffers
 * at draw time for each gear
 *
...
/*
 * Gear
 * This class contains the properties of a single gear and a function to
...
class Gear {
 public:
  ...
  // This way we can put all gears into single vertex and index buffers instead
  // of having to allocate single buffers for each gear (which would be bad
  // practice)
  void generate(GearDefinition& gearDefinition,
    ...
    // We need to know where this triangle's indices start within the single
    // index buffer
    ...
    auto addVertex = [this, &vertexBuffer](float x, float y, float z,
                                           glm::vec3 normal) {
      Vertex v{};
      v.position = {x, y, z};
      v.normal = normal;
    ...
    for (i = 0; i < gearDefinition.numTeeth; i++) {
      ...
      ix0 = addVertex(r0 * cos_ta, r0 * sin_ta, gearDefinition.width * 0.5f,
                      normal);
      ix1 = addVertex(r1 * cos_ta, r1 * sin_ta, gearDefinition.width * 0.5f,
                      normal);
      ix2 = addVertex(r0 * cos_ta, r0 * sin_ta, gearDefinition.width * 0.5f,
                      normal);
      ix3 = addVertex(r1 * cos_ta_3da, r1 * sin_ta_3da,
                      gearDefinition.width * 0.5f, normal);
      ix4 = addVertex(r0 * cos_ta_4da, r0 * sin_ta_4da,
                      gearDefinition.width * 0.5f, normal);
      ix5 = addVertex(r1 * cos_ta_4da, r1 * sin_ta_4da,
                      gearDefinition.width * 0.5f, normal);
      addFace(ix0, ix1, ix2);
      addFace(ix1, ix3, ix2);
      addFace(ix2, ix3, ix4);
      ...
      // Teeth front face
      normal = glm::vec3(0.0f, 0.0f, 1.0f);
      ix0 = addVertex(r1 * cos_ta, r1 * sin_ta, gearDefinition.width * 0.5f,
                      normal);
      ix1 = addVertex(r2 * cos_ta_1da, r2 * sin_ta_1da,
                      gearDefinition.width * 0.5f, normal);
      ix2 = addVertex(r1 * cos_ta_3da, r1 * sin_ta_3da,
                      gearDefinition.width * 0.5f, normal);
      ix3 = addVertex(r2 * cos_ta_2da, r2 * sin_ta_2da,
                      gearDefinition.width * 0.5f, normal);
      addFace(ix0, ix1, ix2);
      addFace(ix1, ix3, ix2);
      ...
      ix2 = addVertex(r1 * cos_ta_3da, r1 * sin_ta_3da,
                      -gearDefinition.width * 0.5f, normal);
      ix3 = addVertex(r0 * cos_ta, r0 * sin_ta, -gearDefinition.width * 0.5f,
                      normal);
      ix4 = addVertex(r1 * cos_ta_4da, r1 * sin_ta_4da,
                      -gearDefinition.width * 0.5f, normal);
      ix5 = addVertex(r0 * cos_ta_4da, r0 * sin_ta_4da,
                      -gearDefinition.width * 0.5f, normal);
      addFace(ix0, ix1, ix2);
      addFace(ix1, ix3, ix2);
      addFace(ix2, ix3, ix4);
      ...
      // Teeth back face
      normal = glm::vec3(0.0f, 0.0f, -1.0f);
      ix0 = addVertex(r1 * cos_ta_3da, r1 * sin_ta_3da,
                      -gearDefinition.width * 0.5f, normal);
      ix1 = addVertex(r2 * cos_ta_2da, r2 * sin_ta_2da,
                      -gearDefinition.width * 0.5f, normal);
      ix2 = addVertex(r1 * cos_ta, r1 * sin_ta, -gearDefinition.width * 0.5f,
                      normal);
      ix3 = addVertex(r2 * cos_ta_1da, r2 * sin_ta_1da,
                      -gearDefinition.width * 0.5f, normal);
      addFace(ix0, ix1, ix2);
      addFace(ix1, ix3, ix2);
      ...
      ix1 = addVertex(r1 * cos_ta, r1 * sin_ta, -gearDefinition.width * 0.5f,
                      normal);
      ix2 = addVertex(r2 * cos_ta_1da, r2 * sin_ta_1da,
                      gearDefinition.width * 0.5f, normal);
      ix3 = addVertex(r2 * cos_ta_1da, r2 * sin_ta_1da,
                      -gearDefinition.width * 0.5f, normal);
      addFace(ix0, ix1, ix2);
      ...
      ix0 = addVertex(r2 * cos_ta_1da, r2 * sin_ta_1da,
                      gearDefinition.width * 0.5f, normal);
      ix1 = addVertex(r2 * cos_ta_1da, r2 * sin_ta_1da,
                      -gearDefinition.width * 0.5f, normal);
      ix2 = addVertex(r2 * cos_ta_2da, r2 * sin_ta_2da,
                      gearDefinition.width * 0.5f, normal);
      ix3 = addVertex(r2 * cos_ta_2da, r2 * sin_ta_2da,
                      -gearDefinition.width * 0.5f, normal);
      addFace(ix0, ix1, ix2);
      ...
      ix0 = addVertex(r2 * cos_ta_2da, r2 * sin_ta_2da,
                      gearDefinition.width * 0.5f, normal);
      ix1 = addVertex(r2 * cos_ta_2da, r2 * sin_ta_2da,
                      -gearDefinition.width * 0.5f, normal);
      ix2 = addVertex(r1 * cos_ta_3da, r1 * sin_ta_3da,
      ...
      ix0 = addVertex(r1 * cos_ta_3da, r1 * sin_ta_3da,
                      gearDefinition.width * 0.5f, normal);
      ix1 = addVertex(r1 * cos_ta_3da, r1 * sin_ta_3da,
                      -gearDefinition.width * 0.5f, normal);
      ix2 = addVertex(r1 * cos_ta_4da, r1 * sin_ta_4da,
                      gearDefinition.width * 0.5f, normal);
      ix3 = addVertex(r1 * cos_ta_4da, r1 * sin_ta_4da,
                      -gearDefinition.width * 0.5f, normal);
      addFace(ix0, ix1, ix2);
      addFace(ix1, ix3, ix2);
      ...
      ix1 = addVertex(r0 * cos_ta, r0 * sin_ta, gearDefinition.width * 0.5f,
                      glm::vec3(-cos_ta, -sin_ta, 0.0f));
      ix2 = addVertex(r0 * cos_ta_4da, r0 * sin_ta_4da,
                      -gearDefinition.width * 0.5f,
                      glm::vec3(-cos_ta_4da, -sin_ta_4da, 0.0f));
      ix3 = addVertex(r0 * cos_ta_4da, r0 * sin_ta_4da,
                      gearDefinition.width * 0.5f,
                      glm::vec3(-cos_ta_4da, -sin_ta_4da, 0.0f));
      addFace(ix0, ix1, ix2);
      addFace(ix1, ix3, ix2);
...
class VulkanExample : public VulkanExampleBase {
 public:
  ...
  // Even though this sample renders multiple objects (gears), we only use
  // single buffers This is a best practices and Vulkan applications should keep
  // the number of memory allocations as small as possible Having as little
  // buffers as possible also reduces the number of buffer binds
  ...
  struct UniformData {
    ...
    glm::mat4 view;
    glm::vec4 lightPos;
    // The model matrix is used to rotate a given gear, so we have one mat4 per
    // gear
  ...
  void prepareGears() {
    ...
    // We'll be using a single vertex and a single index buffer for all the
    // gears, no matter their number This is a Vulkan best practice as it keeps
    // the no. of memory/buffer allocations low Vulkan offers all the tools to
    // easily index into those buffers at a later point (see the
    // buildCommandBuffers function)
    ...
    vulkanDevice->createBuffer(
        ...
        &vertexStaging, vertexBufferSize, vertices.data());
    vulkanDevice->createBuffer(VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
                               VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT,
                               &indexStaging, indexBufferSize, indices.data());
  ...
  void setupDescriptors() {
    // We use a single descriptor set for the uniform data that contains both
    // global matrices as well as per-gear model matrices
  ...
  void preparePipelines() {
    ...
    shaderStages[0] = loadShader(getShadersPath() + "gears/gears.vert.spv",
                                 VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = loadShader(getShadersPath() + "gears/gears.frag.spv",
                                 VK_SHADER_STAGE_FRAGMENT_BIT);

    // Vertex bindings and attributes to match the vertex buffers storing the
    // vertices for the gears
    VkVertexInputBindingDescription vertexInputBinding = {
        vks::initializers::vertexInputBindingDescription(
            0, sizeof(Gear::Vertex), VK_VERTEX_INPUT_RATE_VERTEX)};
    std::vector<VkVertexInputAttributeDescription> vertexInputAttributes = {
        vks::initializers::vertexInputAttributeDescription(
            0, 0, VK_FORMAT_R32G32B32_SFLOAT,
            offsetof(Gear::Vertex, position)),  // Location 0 : Position
        vks::initializers::vertexInputAttributeDescription(
            0, 1, VK_FORMAT_R32G32B32_SFLOAT,
            offsetof(Gear::Vertex, normal)),  // Location 1 : Normal
        vks::initializers::vertexInputAttributeDescription(
            0, 2, VK_FORMAT_R32G32B32_SFLOAT,
            offsetof(Gear::Vertex, color)),  // Location 2 : Color
    };
  ...
  void updateUniformBuffers() {
    ...
    // Update the model matrix for each gear that contains it's position and
    // rotation
    for (auto i = 0; i < numGears; i++) {
      ...
      uniformData_.model[i] =
          glm::rotate(uniformData_.model[i],
  ...
  void buildCommandBuffer() {
    ...
    // Vertices, indices and uniform data for all gears are stored in single
    // buffers, so we only need to bind one buffer of each type and then
    // index/offset into that for each separate gear
    ...
    for (auto j = 0; j < numGears; j++) {
      // We use the instance index (last argument) to pass the index of the
      // triangle to the shader With this we can index into the model matrices
      // array of the uniform buffer like this (see gears.vert):
      // ubo.model[gl_InstanceIndex];
      vkCmdDrawIndexed(cmdBuffer, gears[j].indexCount, 1, gears[j].indexStart,
                       0, j);
    }
