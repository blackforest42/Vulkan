/*
 * Vulkan Example - Using VK_KHR_dynamic_rendering for rendering without
...
class VulkanExample : public VulkanExampleBase {
 public:
  ...
  void preparePipelines() {
    // Layout
    // Uses set 0 for passing vertex shader ubo and set 1 for fragment shader
    // images (taken from glTF model)
    ...
    shaderStages[0] =
        loadShader(getShadersPath() + "dynamicrendering/texture.vert.spv",
